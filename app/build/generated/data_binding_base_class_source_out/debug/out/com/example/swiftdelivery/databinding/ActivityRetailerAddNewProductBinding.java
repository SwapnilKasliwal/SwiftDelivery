...
public final class ActivityRetailerAddNewProductBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityRetailerAddNewProductBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityRetailerAddNewProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRetailerAddNewProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_retailer_add_new_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRetailerAddNewProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRetailerAddNewProductBinding((RelativeLayout) rootView, addNewProduct,
