...
public final class ProductsDisplayBinding implements ViewBinding {
  @NonNull
  ...
  private ProductsDisplayBinding(@NonNull CardView rootView, @NonNull TextView productDescription,
  ...
  @NonNull
  public static ProductsDisplayBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ProductsDisplayBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.products_display, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ProductsDisplayBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProductsDisplayBinding((CardView) rootView, productDescription, productImage,
