    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartConfirmOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RetailerCartActivity.this, RetailerConfirmFinalOrder.class);
                            ...
                            public void onClick(View v) {
                                ...
                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(which == 0) {
                                            Intent intent = new Intent(RetailerCartActivity.this, RetailerProductsDetailsActivity.class);
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if(task.isSuccessful()) {
                                                                Toast.makeText(RetailerCartActivity.this, "Item removed successfully", Toast.LENGTH_SHORT).show();
                                                                Intent intent = new Intent(RetailerCartActivity.this, RetailerOrderProducts.class);
                                                                startActivity(intent);
                                                            }
                                                        }
                                                    });
