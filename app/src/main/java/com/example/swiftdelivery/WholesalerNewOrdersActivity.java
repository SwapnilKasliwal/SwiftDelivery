...
import com.example.swiftdelivery.Models.WholesalerOrders;
...
public class WholesalerNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ordersRef= FirebaseDatabase.getInstance().getReference().child("OrdersRetailer");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<RetailerOrders, WholesalerNewOrdersActivity.RetailerOrdersViewHolder>adapter=
                new FirebaseRecyclerAdapter<RetailerOrders, WholesalerNewOrdersActivity.RetailerOrdersViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull WholesalerNewOrdersActivity.RetailerOrdersViewHolder holder, int position, @NonNull RetailerOrders model) {
                        ...
                        holder.ShowOrdersBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent intent =new Intent(WholesalerNewOrdersActivity.this,WholesalerUserProductActivity.class);
                    ...
                    @NonNull
                    @Override
                    public WholesalerNewOrdersActivity.RetailerOrdersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.orders_layout,parent,false);
                        return new WholesalerNewOrdersActivity.RetailerOrdersViewHolder(view);
                    }
                };
